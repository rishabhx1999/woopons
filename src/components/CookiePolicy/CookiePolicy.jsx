...
const CookiePolicy = () => {
  return (
    <section className="cookie-policy-wrapper">
      <div className="cookie-policy-container innerWidth">
        <h3 className="cookie-policy-title">COOKIE POLICY</h3>
        <div className="cookie-policy-welcome">
          <h4 className="cookie-policy-welcome-title">WELCOME TO WOO-PONS!</h4>
          <div className="cookie-policy-welcome-content">
            ...
            <ul>
              <li>WOO-PONS, LLC.</li>
              <li>
                <a href="mailto:hello@woo-pons.com">Hello@Woo-Pons.com</a>
              </li>
              <li>508-422-5858</li>
            </ul>
            <p>
            ...
            <p>
              By using the website, you accept the use of cookies by WOO-PONS,
              in the terms contained in this policy.
            </p>
          </div>
        </div>
        <div className="cookie-policy-cookies">
          <h4 className="cookie-policy-cookies-title">1. WHAT ARE COOKIES?</h4>
          <div className="cookie-policy-cookies-content">
            <p>
        ...
        <div className="cookie-policy-refuse">
          <h4 className="cookie-policy-refuse-title">
            2. REFUSING OR WITHDRAWING CONSENT TO THE USE OF COOKIES
          </h4>
          <div className="cookie-policy-refuse-content">
            <p>
              ...
              access or use all or parts of the functionalities of the website.
            </p>
            <p>
              ...
              website from placing further cookies on your device unless and
            ...
            <ul>
              <li>
                Microsoft Edge:
                <a href="https://support.microsoft.com/en-us/office/delete-cookies-inmicrosoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09?ui=en-us&rs=enus&ad=us">
                  https://support.microsoft.com/en-us/office/delete-cookies-inmicrosoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09?ui=en-us&rs=enus&ad=us
                </a>
              </li>
              <li>
                Firefox:
                <a href="https://support.mozilla.org/en-US/kb/clear-cookies-and-site-datafirefox">
                  https://support.mozilla.org/en-US/kb/clear-cookies-and-site-datafirefox
                </a>
              </li>
              <li>
                Chrome:
              ...
              <li>
                Safari:
                <a href="https://support.apple.com/guide/safari/manage-cookies-and-websitedata-sfri11471/mac">
                  https://support.apple.com/guide/safari/manage-cookies-and-websitedata-sfri11471/mac
                </a>
              </li>
            </ul>
            <p>
        ...
        <div className="cookie-policy-first-party">
          <h4 className="cookie-policy-first-party-title">
            3. FIRST-PARTY COOKIES
          </h4>
          <div className="cookie-policy-first-party-content">
            <p>
        ...
        <div className="cookie-policy-third-party">
          <h4 className="cookie-policy-third-party-title">
            4. THIRD-PARTY COOKIES
          </h4>
          <div className="cookie-policy-third-party-content">
            <p>
        ...
        <div className="cookie-policy-types">
          <h4 className="cookie-policy-types-title">5. COOKIES WE USE</h4>
          <div className="cookie-policy-types-content">
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  The JSESSIONID cookie is used by New Relic to store a session
                  identifier so that New Relic can monitor session counts for an
                  application.
                </td>
                <td>session</td>
                <td>Necessary</td>
        ...
        <div className="cookie-policy-purpose">
          <h4 className="cookie-policy-purpose-title">
            6. PURPOSES OF OUR COOKIES
          </h4>
          <div className="cookie-policy-purpose-content">
            ...
            <p>
              ...
              details to improve how our website functions and to understand how
        ...
        <div className="cookie-policy-contact">
          <h4 className="cookie-policy-contact-title">7. CONTACT US</h4>
          <div className="cookie-policy-contact-content">
            <p>
